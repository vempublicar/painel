<a href="dashboard&setting=minhas-empresas" class="text-secondary" aria-current="true">
            ...
            <a href="painel&a=analises" class="text-secondary">
            ...
            <a href="painel&a=treinamento" class="text-secondary">
