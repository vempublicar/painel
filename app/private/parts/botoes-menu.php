<a href="dashboard&setting=minhas-empresas" class="text-primary" aria-current="true">
            ...
            <a href="painel&a=analises" class="text-primary">
            ...
            <a href="painel&a=treinamento" class="text-primary">
            ...
            <a href="painel&a=estrategias" class="text-primary">
