<a href="dashboard&setting=minhas-empresas" class="text-primar" aria-current="true">
            ...
            <a href="painel&a=analises" class="text-primar">
            ...
            <a href="painel&a=estrategias" class="text-primar">
