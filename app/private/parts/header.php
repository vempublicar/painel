  ...
  <header class="navbar d-print-none header1">
    <div class="container-xl">
      ...
      <div class="m-auto  d-print-none">
        <div class="btn-list">
            <a href="dashboard&setting=minhas-empresas" class="btn " aria-current="true">
            ...
            <a href="painel&a=analises" class="btn ">
            ...
            <a href="painel&a=treinamento" class="btn ">
            ...
            <a href="painel&a=estrategias" class="btn ">
            ...
            <a class="btn " data-bs-toggle="offcanvas" href="#offNotifica" role="button" aria-controls="offcanvasStart">
