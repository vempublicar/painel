<div class="page-body">
    <div class="container-xl">
        ...
        <div class="col-sm-12 mt-4">
            <h3 class="text-secondary text-center"> Disponível para gerenciamento </h3>
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card card-sm">
                        <div class="card-body">
                            ...
                            <h3 class="card-title">Controle Estrutural</h3>
                            <div class="divide-y-2 mt-4">
                                <div>
                                    <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon text-green" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="card-stamp">
                                <div class="card-stamp-icon bg-secondary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-lamp-2">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path d="M5 21h9" />
                            ...
                            <h3 class="card-title">Controle de Produtos</h3>
                            <div class="divide-y-2 mt-4">
                                <div>
                                    <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon text-green" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card card-sm">
                        <div class="card-body">
                            ...
                            <h3 class="card-title">Controle de Anúncios</h3>
                            <div class="divide-y-2 mt-4">
                                <div>
                                    <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon text-green" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card card-sm">
                        <div class="card-body">
                            ...
                            <h3 class="card-title">Controle de Cliente</h3>
                            <div class="divide-y-2 mt-4">
                                <div>
                                    <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon text-green" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="card-stamp">
                                <div class="card-stamp-icon bg-secondary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-affiliate">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <h3 class="card-title">Controle Operacional</h3>
                            <div class="divide-y-2 mt-4">
                                <div>
                                    <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon text-green" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<?php
 //include "app/private/parts/offcanvas.php";
?>