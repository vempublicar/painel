    ...
    <div class="row plans-section gx-3 gy-4">
      ...
      <div class="col-md-3">
        <div class="col-plan h-100 d-flex flex-column justify-content-between">
          ...
          <div>
            <a href="register&plano=<?= base64_encode('Gratuito') ?>" class="btn btn-primary">COMECE AGORA</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="col-plan h-100 d-flex flex-column justify-content-between">
          ...
          <div>
            <a href="register&plano=<?= base64_encode('Estrategia') ?>" class="btn btn-primary">COMECE AGORA</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="col-plan h-100 d-flex flex-column justify-content-between">
          ...
          <div>
            <a href="register&plano=<?= base64_encode('Ferramenta') ?>" class="btn btn-primary">COMECE AGORA</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="highlight-box h-100 d-flex flex-column justify-content-center">
          ...
          <div>
            <a href="register&plano=<?= base64_encode('Personalizado') ?>" class="btn btn-light"><i class="bi bi-chat-dots me-2"></i> Fale com Consultor</a>
          </div>
        </div>
      </div>
    </div>
